...
//: Gettable Property
//: > Create a variable that can be read. It can't be modified
class NumberClass {
...
//: Applications
//: 1. Grabbing and Storing data to the server //unchangeable
//: 2. Propagating relationships between properties
//: 3. Preventing others from manuplating your code
